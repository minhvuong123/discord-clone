...
import { Edit, Hash, Lock, Mic, Plus, Settings, Trash, Video } from "lucide-react";
...
export const ServerChannel = ({
  ...
  return (
    ...
    >
      ...
      <p className={cn(
        "line-clamp-1 font-semibold text-sm text-zinc-500 group-hover:text-zinc-600 dark:text-zinc-400 dark:group-hover:text-zinc-300 transition text-start",
